...
const ratingRouter = require("./routes/review.js");
...
app.use((req, res, next) => {
    ...
    res.locals.logedin = req.flash("logedin");
    res.locals.loginReq = req.flash("loginReq");
...
app.use("/listings/:id/reviews", ratingRouter);
